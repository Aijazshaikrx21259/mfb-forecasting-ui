...
import { loadItemInsight, type ItemInsightData } from "@/lib/item-insights";
...
export default async function ItemPage({ params }: ItemPageProps) {
  ...
  let insight: ItemInsightData | null = null;
  ...
  const forecastUnavailableMessage = (() => {
    ...
    if (detail.includes("(404)")) {
      return "This item does not yet have a champion forecast. Run the forecasting pipeline or verify that the item appears in analytics.item_champion.";
    }
    if (detail) {
      return detail;
    }
