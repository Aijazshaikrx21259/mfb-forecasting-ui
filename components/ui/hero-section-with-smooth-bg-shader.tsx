        ...
        <div className="text-center">
          ...
          {buttonText ? (
            <button
              ...
              className={`px-6 py-4 sm:px-8 sm:py-6 rounded-full border-4 bg-background/80 border-card text-sm sm:text-base text-foreground hover:bg-background/90 transition-colors ${buttonClassName}`}
            >
              {buttonText}
            </button>
          ) : null}
